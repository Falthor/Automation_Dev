...
namespace Game.Data
{
    ...
    /// DATACENTER.md calls out as parameters rather than buried constants.
    /// </summary>
    ...
    public sealed class DataCenterDefinition : BuildingDefinition
    {
        ...
        /// DATACENTER.md) - 0.20 with the current two axes (research/buildings). Will
        ...
        /// <summary>Seed for the per-component nominal-lifetime draw (DATACENTER.md) - same seed and installation sequence must reproduce the same drawn lifetimes.</summary>
