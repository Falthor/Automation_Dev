...
namespace Game.Gameplay.Buildings
{
    ...
    /// per item, any building occupying a neighbour cell counting as a candidate exit, and a
    /// jammed assigned exit not blocking the others. Holds at most one item at a time - no
